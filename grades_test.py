...
def test_goal_percent_nested_percent() -> None:
	...
	question01.set_grade_received(10)
	question02.set_grade_received(10)
	question03.set_grade_received(10)
	question04.set_grade_received(5)
...
def test_goal_percent_updating() -> None:
	...
	# one grade received
	question01.set_grade_received(8)
	for p in [question01]:
	...
	# two grade received
	question02.set_grade_received(8)
	...
	# four grade received
	question04.set_grade_received(10)
	...
	# five grade received
	question05.set_grade_received(10)
...
# 	final_pt01 = Grades("final 01", 15, 80, None)
# 	final_pt02 = Grades("final 02", 15, 80, None)
# 	final_pt03 = Grades("final 03", 15, 80, None)
# 	final.add_subgrade(final_pt01)
# 	final.add_subgrade(final_pt02)
# 	final.add_subgrade(final_pt03)
